...
import 'package:todo_quest/feture/screens/quests_recommended/state/recommended_quests_state.dart';
...
class RecommendedQuestsViewModel extends StateNotifier<RecommendedQuestsState> {
  RecommendedQuestsViewModel() : super(RecommendedQuestsState()) {
    _initialize();
  }
...
final recommendedQuestsViewModelProvider =
    StateNotifierProvider<RecommendedQuestsViewModel, RecommendedQuestsState>((ref) {
  return RecommendedQuestsViewModel();
});